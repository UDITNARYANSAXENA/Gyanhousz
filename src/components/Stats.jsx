...
const stats = [
  {
    ...
    description: "Rapidly expanding across India"
  },
  {
    icon: <Users className="text-emerald-500" />,
    value: "10,000+",
    label: "Students Impacted",
    description: "Transforming young minds daily"
  },
  {
    icon: <Target className="text-orange-500" />,
    value: "15 Days",
    label: "Fastest Setup",
    description: "Quickest launch in the industry"
  },
  {
    icon: <Award className="text-purple-500" />,
    value: "98%",
    label: "Retention Rate",
    description: "Franchisee satisfaction & success"
  }
];
